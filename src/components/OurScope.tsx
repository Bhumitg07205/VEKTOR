...
const PROJECTS = [
  {
    ...
    year: "2023",
    tagline: "No more circling. Every spot, tracked. Authorized only for Faculty",
    desc: "Geomagnetic sensors under every slot. ANPR Technology at Entry & Exit. A real-time screen that tells you where to park — before you even enter. Deployed at Admin-Side Main Parking,Thapar University",
    funding: "₹8L+",
    impact: "3,000+",
